        ...
        <div className="container-xxl">
          <div className="row">
            ...
            <div className="col-3">
              <div className="famous-card position-relative">
                <img
                  src="assets/images/famous-2.jpg"
                  className="img-fluid"
                  alt="watch"
                />
                <div className="famous-content position-absolute">
            ...
            <div className="col-3">
              <div className="famous-card position-relative">
                <img
                  src="assets/images/famous-4.jpg"
                  className="img-fluid"
                  alt="smartphone"
                />
                <div className="famous-content position-absolute">
            ...
            <div className="col-3">
              <div className="famous-card position-relative">
                <img
                  src="assets/images/famous-3.jpg"
                  className="img-fluid"
                  alt="speakers"
                />
                <div className="famous-content position-absolute">
                  ...
                  <p className="text-dark fw-semibold">
                    From #100,000 or #12,000/mo. for 12 mo.*
                  </p>
                </div>
              </div>
            </div>
